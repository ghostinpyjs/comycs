...
const DISCORD_URL = "https://discord.gg/5v6NN5ptSe";
...
const AUTH = {
  ...
  renderNav() {
    ...
    if (navLinks) {
      ...
      // Discord
      if (!document.getElementById('nav-discord-link')) {
        const li = document.createElement('li');
        li.id = 'nav-discord-link';
        li.innerHTML = `<a href="${DISCORD_URL}" target="_blank" rel="noopener" style="color:#5865F2">
